...
import { resolveAIRecordingOptions, buildMethodPath, extractSystemInstructions } from '../ai/utils.js';
import { CHATS_CREATE_METHOD, GOOGLE_GENAI_METHOD_REGISTRY, CHAT_PATH, GOOGLE_GENAI_SYSTEM_NAME } from './constants.js';
 ...
 */
function addPrivateRequestAttributes(span, params, isEmbeddings) {
  if (isEmbeddings) {
